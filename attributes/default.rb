# Installer locations, one of these must be defined, but we'll leave that up to our Vagrant file instead
...
# default['cf902']['installer']['local_file'] = "/vagrant/ColdFusion_9_WWEJ_linux64.bin"
